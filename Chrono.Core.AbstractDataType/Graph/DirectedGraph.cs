...
namespace Chrono.AbstractDataType.Graph
{
	...
	{
		//private OrderedMap<string, Vertex<TNode>> _vertices;
		//private OrderedMap<Edge<TNode, TEdge>> _edges;
		//private OrderedMap<Vertex<TNode>, OrderedMap<Vertex<TNode>>> _adjacent;
		...
		//{
		//	_vertices = new OrderedMap<string, Vertex<TNode>>(StringComparer.InvariantCultureIgnoreCase);
		//	_edges = new OrderedMap<Edge<TNode, TEdge>>();
		//	_adjacent = new OrderedMap<Vertex<TNode>, OrderedMap<Vertex<TNode>>>();
		//}
		...
		//private OrderedMap<Vertex<TNode>> GetAdjacentVertices(Vertex<TNode> v)
		//{
		//	if (_adjacent.Contains(v)) {
		//		return _adjacent[v];
		//	}
		//	else {
		//		OrderedMap<Vertex<TNode>> adj = new OrderedMap<Vertex<TNode>>();
		//		_adjacent.Add(v, adj);
		//		return adj;
		//	}
		//}
		...
		//public OrderedMap<string, Vertex<TNode>> Vertices 
		//{
		//	get { return _vertices; }
		//}

		//public new OrderedMap<Edge<TNode, TEdge>> Edges
		//{
		//	get { return _edges; }
		//}
